      ...
      <div className="footer-content max-w-6xl mx-auto px-4 sm:px-6">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-3 sm:gap-4">
            ...
            >
              <svg className="w-4 h-4 sm:w-5 sm:h-5 text-neutral-400 hover:text-white" fill="currentColor" viewBox="0 0 24 24">
                <path d="M5 5.5A3.5 3.5 0 018.5 2H12v7H8.5A3.5 3.5 0 015 5.5zM12 2h3.5a3.5 3.5 0 110 7H12V2zm0 7h3.5a3.5 3.5 0 110 7H12V9zm-7 7a3.5 3.5 0 013.5-3.5H12v3.5a3.5 3.5 0 11-7 0zm0-7A3.5 3.5 0 018.5 9H12v7H8.5A3.5 3.5 0 015 12.5z"/>
              </svg>
            </a>
          </div>
        </div>
